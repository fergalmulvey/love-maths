...
function checkAnswer(){
    ...
    if(isCorrect){
        ...
        alert(`Stop this silliness, the answer is ${calculatedAnswer[0]} and you answered ${userAnswer}? `);
...
function calculateCorrectAnswer(){
 ...
 /**
  * Gets the current score, increments, then updates the dom
  */
function incrementScore(){
 ...
 /**
  * Gets the current wrong answers score, increments, then updates the dom
  */
